    ...
    <>
      ...
      <div className="max-w-5xl mx-auto px-6 py-10 grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-8">
            <div className="flex gap-5 items-start mb-6">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-gray-400 mb-3">{location}{pro.years_experience ? ` · ${pro.years_experience} years experience` : ''}</div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {(
                [
                  ['Trade', trade],
                  ['Location', location || '—'],
                  pro.years_experience ? ['Experience', `${pro.years_experience} years`] : null,
                  pro.zip_code ? ['Zip code', pro.zip_code] : null,
          ...
          {/* Reviews */}
          <div className="bg-white border border-gray-100 rounded-2xl p-7">
            <div className="text-xs font-semibold text-gray-400 uppercase tracking-widest mb-5">Reviews ({reviews.length})</div>
            {reviews.length === 0 ? (
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-7 sticky top-20">
          {submitted ? (
            <div className="text-center py-6">
              ...
              <p className="text-sm text-gray-400">Your message has been sent to {pro.full_name.split(' ')[0]}. They will be in touch soon.</p>
            </div>
          ) : (
            <>
              <h2 className="font-serif text-xl text-gray-900 mb-1">Contact {pro.full_name.split(' ')[0]}</h2>
              ...
              {[
                { id: 'name', label: 'Your name', value: name, set: setName, placeholder: 'John Smith', type: 'text' },
                { id: 'email', label: 'Email', value: email, set: setEmail, placeholder: 'john@example.com', type: 'email' },
                { id: 'phone', label: 'Phone (optional)', value: phone, set: setPhone, placeholder: '(555) 000-0000', type: 'tel' },
              ].map(f => (
              ...
              <p className="text-xs text-gray-400 text-center mt-3">Your details are only shared with {pro.full_name.split(' ')[0]}.</p>
                  ...
                  <div className="flex items-center gap-3 bg-stone-50 rounded-xl p-3">
                    ...
                    <div>
                      ...
                      {paid ? (
                        ...
                        <div className="text-sm text-gray-400 italic">Upgrade to Pro to view</div>
                      )}
                    </div>
                  </div>
                </>
