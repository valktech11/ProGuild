    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-6 py-14">
        ...
        {[
          ...
          { title: '6. Your rights', content: `You have the right to access, correct, or delete your personal information at any time through your account settings or by contacting us at privacy@proguild.ai. You may request a copy of your data in a portable format. You may opt out of non-transactional emails at any time using the unsubscribe link in any email. If you are in the European Economic Area, you have additional rights under GDPR. If you are in California, you have additional rights under CCPA.` },
          ...
          { title: '11. SMS Communications', content: `If you provide your phone number through a contractor using ProGuild.ai, you may receive SMS messages related to your project including appointment confirmations, status updates, estimate notifications, and invoice reminders. Mobile phone numbers collected through SMS communications are not shared with third parties or affiliates for marketing or promotional purposes. Message and data rates may apply. Reply STOP to opt out at any time. Reply HELP for help. Message frequency varies.` },
