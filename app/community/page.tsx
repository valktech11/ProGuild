      ...
      <div className="bg-white border-b" style={{ borderColor: '#E8E2D9' }}>
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-3">
          ...
          <div className="flex gap-5 overflow-x-auto pb-1" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
            {[
              { label: 'Roofing',       img: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=120&h=120&fit=crop', slug: 'roofer' },
              ...
              { label: 'HVAC',          img: 'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=120&h=120&fit=crop', slug: 'hvac-technician' },
