      ...
      <div className="bg-white border-b" style={{ borderColor: '#E8E2D9' }}>
        <div className="px-4 sm:px-6 py-3">
          ...
          <div className="flex gap-5 overflow-x-auto pb-1" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
            {[
              { label: 'Roofing',       img: 'https://images.unsplash.com/photo-1605450099279-533bd3ce379a?w=120&h=120&fit=crop', slug: 'roofing' },
              ...
              { label: 'Storm Damage',  img: 'https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?w=120&h=120&fit=crop', slug: 'roofing' },
