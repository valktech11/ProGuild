...
export async function PATCH(req: NextRequest, context: { params: Promise<{ id: string }> }) {
  ...
  const allowed = ['full_name','phone','city','state','zip_code','bio','years_experience',
    'profile_photo_url','license_number','is_verified','plan_tier','stripe_customer_id',
    'profile_status','trade_category_id']
