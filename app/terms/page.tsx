  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-6 py-14">
        ...
        {[
          { title: '1. Acceptance of terms', content: 'By accessing or using TradesNetwork ("the platform"), you agree to be bound by these Terms of Service. If you do not agree, do not use the platform. These terms apply to all users including homeowners, trade professionals, and employers.' },
          { title: '2. Description of service', content: 'TradesNetwork is a professional platform connecting licensed trade professionals with homeowners and employers. We provide tools for professional profiles, lead connections, community engagement, and portfolio management. We are not a party to any agreement between homeowners and trade professionals — we facilitate connections only.' },
          ...
          { title: '14. Contact', content: 'For questions about these terms, contact us at: legal@tradesnetwork.com' },
        ].map(section => (
