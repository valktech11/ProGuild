...
export default function RevenuePage() {
  ...
  useEffect(() => {
    ...
    fetch(`/api/roofing/revenue?pro_id=${s.id}`)
      .then(r => r.json())
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          {loading ? (
            ...
            <>
              ...
              <div style={card}>
                <div style={{ fontSize: 15, fontWeight: 700, color: t.textPri, marginBottom: 4 }}>By insurance carrier</div>
                <div style={{ fontSize: 12, color: t.textMuted, marginBottom: 14 }}>Where your won revenue comes from — your claims data starting to compound.</div>
