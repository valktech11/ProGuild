                ...
                <div style={{minWidth:0}}>
                  ...
                  {isRoofing && (() => {
                    ...
                    const NA:Record<string,{title:string;sub:string;cta:string;onClick:()=>void;mins:string;icon:React.ReactNode}> = {
                      ...
                      lf:       {title:'Capture linear footage', sub:'Trace ridge, hip & valley in ProMeasure. Drives supplement checklist and materials.', cta:'Open ProMeasure', onClick:goPromeasure, mins:'2 min', icon:<><rect x="2" y="9" width="20" height="6" rx="1.5"/><path d="M6 9v2.5M10 9v3M14 9v2.5M18 9v3"/></>},
