  ...
  return (
    <div style={{
      ...
      <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', gap:12, padding:'13px 18px', cursor: (!open && !locked) ? 'pointer' : 'default', background:'transparent' }}
        ...
        {/* Right side: decision status pill + change on an active claim; enable switch when off */}
        {open && decided ? (
          <div style={{ display:'inline-flex', alignItems:'center', gap:8, flexShrink:0 }} onClick={e=>e.stopPropagation()}>
